import { Props, optionType } from "../types";
...
const Search = ({
  ...
  return (
    <main className="flex justify-center items-center bg-gradient-to-br from-sky-400 via-purple-500 to-lime-400 h-[100vh] w-full">
